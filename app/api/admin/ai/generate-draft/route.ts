...
JSON Schema:
{
  ...
  "viBody": "nội dung chi tiết bằng HTML tiếng Việt. BẮT BUỘC phải chia bài viết thành 3-4 phần lớn sử dụng tiêu đề thẻ h2 (ví dụ: <h2>1. Tiêu đề phần</h2>) và các mục nhỏ bằng thẻ h3 (ví dụ: <h3>1.1. Tiêu đề mục</h3>) xen kẽ các thẻ p, strong, ul, li để hệ thống tự động nhận diện sinh mục lục.",
  "enBody": "detailed post content in HTML English. MUST split the content into 3-4 main sections using h2 tags (e.g. <h2>1. Section Title</h2>) and sub-sections using h3 tags (e.g. <h3>1.1. Subsection Title</h3>) mixed with p, strong, ul, li tags so the system can auto-generate the table of contents.",
  "seoTitleVi": "tiêu đề SEO tiếng Việt (< 60 ký tự)",
  "seoTitleEn": "SEO title English (< 60 characters)",
  "seoDescVi": "mô tả SEO tiếng Việt (< 160 ký tự)",
  "seoDescEn": "SEO description English (< 160 characters)"
