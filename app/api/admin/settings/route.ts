...
export async function GET() {
  ...
  return NextResponse.json({
    ...
    contactProvinceName: settingsAny?.contact_province_name || "",
    contactWardCode: settingsAny?.contact_ward_code || "",
    contactWardName: settingsAny?.contact_ward_name || "",
    contactStreet: settingsAny?.contact_street || "",
    defaultLocale: "vi",
...
export async function PUT(request: Request) {
  ...
  const settingsPayload = {
    ...
    contact_ward_name: body.contactWardName || null,
    contact_street: body.contactStreet || null,
