-- Migration: Fix public_products RPC media alt_text translation and add promo prices
-- Date: 20260618
-- Author: Antigravity

-- Drop all known signatures of public_products
DROP FUNCTION IF EXISTS public_products(text, text, text, text, numeric, numeric, jsonb, boolean, int, int, text, boolean);
DROP FUNCTION IF EXISTS public_products(text, text, text, text, numeric, numeric, jsonb, boolean, int, int);
