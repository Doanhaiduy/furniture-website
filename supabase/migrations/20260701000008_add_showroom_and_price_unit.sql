-- Migration: Add showroom_code and price_unit columns to products and update public_products RPC
-- Date: 20260701

BEGIN;

-- 1. Add showroom_code and price_unit columns to public.products
ALTER TABLE public.products
  ADD COLUMN IF NOT EXISTS showroom_code text,
  ADD COLUMN IF NOT EXISTS price_unit text;

-- 2. Drop all known signatures of public_products to recreate it
