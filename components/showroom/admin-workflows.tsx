...
export const settingsHomepageDefaults = {
  ...
  aboutEyebrowVi: "Về Phương Đông",
  aboutEyebrowEn: "About Phuong Dong",
  aboutJourneyEyebrowVi: "Hành trình phát triển",
  aboutJourneyEyebrowEn: "Our journey",
  aboutJourneyHeadingVi: "Chặng đường hơn 20 năm",
  aboutJourneyHeadingEn: "Over two decades of growth",
  aboutMilestones: [
